...
Plottingseveral items works as well. You will have to exclude `questions` from the `dropdown` input. Note that `split` does not work well with several questions. Therefore, we will replace it with `group`
