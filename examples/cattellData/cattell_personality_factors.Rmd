...
```{r, eval = FALSE, echo=FALSE, results='hide'}
  # those are the original import commands. They might be outdated and are neither shown
  # nor evaluated if you run the rmd file. The data.csv file was downloaded from
  # the site http://personality-testing.info/_rawdata/
  
  # get the likert resplonses
